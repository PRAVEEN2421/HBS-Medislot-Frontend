...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            if (!docImg) {
                return showPremiumNotification({ title: 'Image Required', subtitle: 'Image Not Selected' })
            }
            ...
            if (data.success) {
                showSuccessNotification('Doctor Added', data.message)
                setDocImg(false)
                setName('')
                setPassword('')
                setEmail('')
                ...
                showErrorNotification('Failed to Add', data.message)
            }
